...
class SsaverTester(TestCase):
    ...
    def test_save_load_mock(self):
        ...
        s1["data"] = {'server': '127.0.0.1, 3000', 'port': 3306,
                      "users": {"Alice": "password123", "Bob": "password12"}}
        ...
        self.assert_equal(s2["data"], {'server': '127.0.0.1, 3000', 'port': 3306, "users": {
                          "Alice": "password123", "Bob": "password12"}})
